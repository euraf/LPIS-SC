	...
	data: {
		...
		profiles: {
			researcher: {
				...
				title: "Researcher",
				icon: "fa-flask",
				tagline: "Advanced data exploration across multiple spatial datasets.",
				features: ["Full methodology", "Dataset metadata", "Spatial analysis tools"],
			},
			farmer: {
				id: "farmer",
				title: "Farmer",
				icon: "fa-tractor",
				tagline: "Parcel- and farm-level insights for land management.",
				features: ["Farm overview", "Parcel analysis", "Landscape comparisons"],
			},
			policymaker: {
				id: "policymaker",
				title: "Policymaker",
				icon: "fa-university",
				tagline: "Administrative-level insights for regional policy support.",
				features: ["Regional dashboard", "Inter-region comparisons", "Report generation"],
			},
		},
	},
	created() {
